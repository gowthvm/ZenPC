...
export default function Page() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-bg text-text-primary relative overflow-hidden">
      ...
      {/* Minimal Header */}
      <header className="w-full px-6 pt-8 pb-6 flex items-center justify-between gap-8 max-w-6xl mx-auto">
        <div className="flex items-center gap-3">
          <div className="h-8 w-8 rounded-lg bg-accent flex items-center justify-center font-display text-sm font-bold text-white select-none">Z</div>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/register" className="px-4 py-2 rounded-lg bg-accent text-white text-sm font-medium hover:bg-accent/90 transition-colors">Get Started</Link>
        </div>
      </header>
      ...
      <main className="flex-1 w-full flex flex-col items-center px-4 md:px-6">
        ...
        <section id="hero" className={`w-full max-w-5xl mx-auto text-center space-y-10 pt-32 pb-24 transition-all duration-1000 ${isVisible['hero'] ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            <Link href="/app" className="px-8 py-3 rounded-lg bg-accent text-white font-medium hover:bg-accent/90 transition-colors">
              Start Building
            </Link>
            <Link href="/about" className="px-8 py-3 rounded-lg border border-border text-text-primary font-medium hover:border-text-primary transition-colors">
              Learn More
            </Link>
          </div>
        </section>
        ...
        <section id="features" className={`w-full max-w-7xl mx-auto my-20`}>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="group card p-8 space-y-4 hover:scale-[1.02] transition-all duration-500 hover:shadow-2xl border border-border/10 hover:border-accent/20 relative z-20">
              <div className="flex items-start gap-4">
                <div className="h-12 w-12 rounded-xl bg-gradient-to-br from-accent/20 to-purple-600/20 flex items-center justify-center group-hover:scale-110 transition-transform duration-300 flex-shrink-0 relative z-10">
                  <svg className="w-6 h-6 text-accent relative z-10" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 10V3L4 14h7v7l9-11h-7z" />
                  </svg>
                </div>
                <div>
        ...
        <section className="w-full max-w-5xl mx-auto my-20">
          <div className="p-12 rounded-lg border border-border/20 bg-surface-1/30 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Link href="/guide" className="px-8 py-3 rounded-lg border border-border text-text-primary font-medium hover:border-text-primary transition-colors">
                View Demo
              </Link>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8 py-16">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-4 pt-2">
                {['M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12s4.477 10 10 10 10-4.477 10-10zm-6.5 0l-5-5 1.5-1.5 7 7-7 7-1.5-1.5 5-5z', 
                  ...
                  <div key={i} className="p-2 rounded-lg hover:bg-surface-3/50 transition-colors cursor-pointer">
                    <svg className="w-5 h-5 text-text-muted hover:text-accent" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              ...
              <div key={idx} className="space-y-4">
                ...
                <nav className="space-y-3">
                  {section.links.map((link, linkIdx) => (
                    ...
                    >
                      <span className="h-0.5 w-3 bg-accent/0 group-hover:bg-accent/60 mr-2 transition-all duration-300 group-hover:mr-3"></span>
                      {link.name}
                    </Link>
                  ))}
                </nav>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-4 text-sm">
            ...
            <div className="flex items-center gap-6">
              <Link href="/privacy" className="text-text-muted/80 hover:text-accent transition-colors">
                Privacy Policy
              </Link>
              <Link href="/terms" className="text-text-muted/80 hover:text-accent transition-colors">
                Terms of Service
              </Link>
              <Link href="/cookies" className="text-text-muted/80 hover:text-accent transition-colors">
                Cookies
              </Link>
            </div>
          </div>
