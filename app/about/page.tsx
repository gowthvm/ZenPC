    ...
    <main className="min-h-dvh bg-bg text-text-primary relative overflow-hidden">
      ...
      <div className="relative z-10 max-w-2xl mx-auto px-6 py-16">
        ...
        <div className="card p-8">
          <h1 className="font-display text-3xl font-bold mb-4 bg-gradient-to-r from-accent to-purple-600 bg-clip-text text-transparent">About ZenPC</h1>
          <p className="mb-4 text-text-primary leading-relaxed">ZenPC is a premium web app designed to make building custom PCs simple, clear, and trustworthy. Our goal is to provide a calm, distraction-free experience for enthusiasts and newcomers alike.</p>
          <p className="text-text-primary leading-relaxed">We believe in transparency, privacy, and putting users first—no ads, no upsells, just a clean interface and reliable compatibility checks.</p>
        </div>
      </div>
    </main>
  );
